...
function playRPS(playerMove) 
{
    let outcomes = 
    [
        ["draw", "lose", "win"], // rock, paper, scissors
        ["win", "draw", "lose"], // rock, paper, scissors
        ["lose", "win", "draw"] // rock, paper, scissors
    ];

    let computerMove = Math.floor(Math.random() * 3); // choose rand no between 0 - 2
...
while (continueGame === true) {
    ...
    computerMove = possibleComputerMoves[Math.floor((Math.random()*possibleComputerMoves.length))];
